          ...
          <div className="p-4 flex flex-col gap-2">
            ...
            <form action="">
              ...
              <table className="w-full text-base rtl:text-right m-2 text-center">
                <thead className=" text-text-900 uppercase bg-secondary-500">
                  <tr>
                    ...
                    <th scope="col" className="px-2 py-3 md:px-6 md:py-3 w-full">
                      Full Name
                    </th>
                    <th scope="col" className="px-2 py-3 md:px-6 md:py-3 w-full">
                      College
                ...
                <tbody>
                  <tr className="bg-white border-b">
                    <td className="px-2 py-4 md:px-6 md:py-4 w-fit">1</td>
                    <td
                      scope="row"
                    ...
                    <td className="px-2 py-4 md:px-6 md:py-4 w-full">Silver</td>
                    <td className="px-2 py-4 md:px-6 md:py-4 w-full">Laptop</td>
                  </tr>
                  <tr className="bg-white border-b">
                    <td className="px-2 py-4 md:px-6 md:py-4 w-fit">2</td>
                    <th
                      scope="row"
                      className="px-2 py-4 md:px-6 md:py-4 font-medium text-gray-900 whitespace-nowrap w-fit"
                    >
                      <input
                        type="text"
                        className="border-2 rounded-lg outline-none focus:ring-0 focus:border-accent-500 p-1 md:p-2"
                    ...
                    <td className="px-2 py-4 md:px-6 md:py-4 w-full">White</td>
                    <td className="px-2 py-4 md:px-6 md:py-4 w-full">Laptop PC</td>
                  </tr>
                  <tr className="bg-white dark:bg-gray-800">
                    <td className="px-2 py-4 md:px-6 md:py-4 w-fit">3</td>
                    <th
                      scope="row"
                      className="px-2 py-4 md:px-6 md:py-4 font-medium text-gray-900 whitespace-nowrap w-fit ">
                      <input
                    ...
                    <td className="px-2 py-4 md:px-6 md:py-4 w-full">Black</td>
                    <td className="px-2 py-4 md:px-6 md:py-4 w-full">Accessories</td>
                  </tr>
                </tbody>
              </table>
              <h2 className="text-lg font-semibold mt-4">
              ...
              <div className="w-full flex justify-end gap-2 mt-4">
                <button className="rounded-lg px-2 py-1 border-2 border-accent-200 md:px-4 md:py-2">
                  Clear
                </button>
                <button className="rounded-lg px-2 py-1 bg-green-600 text-white md:px-4 md:py-2">
                  Save
                </button>
              </div>
            </form>
