      ...
      <div className="p-4 md:p-8">
        ...
        <div className="p-4 flex flex-col gap-2">
          <h1 className="text-xl text-text-950 text-center">
            Prize winners of{" "}
            <span className="font-semibold">{event.name}</span> ({event.eventtype} event)
          </h1>
          <form action="" className="overflow-x-auto">
            {/* First Prize */}
            <>
              <h2 className="text-lg font-semibold mt-4">First prize (Winner)</h2>
              {/* For team events */}
              {event.eventtype === "Group" && (
                ...
                <tbody>
                  {formData.firstPrize.map((prize: any, index: number) => (
                    <tr key={index} className="bg-white border-b">
                      <td className="px-2 py-4 md:px-6 md:py-4 w-fit">{index + 1}</td>
                      <td
                        scope="row"
                      ...
                      <td className="px-2 py-4 md:px-6 md:py-4 w-full">{prize.name}</td>
                      <td className="px-2 py-4 md:px-6 md:py-4 w-full">{prize.college}</td>
                      <td className="px-2 py-4 md:px-6 md:py-4 w-full">{prize.mobileNo}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
            ...
            {/* Second Prize */}
            <>
              <h2 className="text-lg font-semibold mt-6">Second prize (Runner)</h2>
              {event.eventtype === "Group" && (
                <div className="flex justify-between">
                  <div className="flex gap-2 text-lg items-center">
                    <label htmlFor="">Team Name</label>
    ...
    <Modal open={modalOpen} onClose={() => setModalOpen(false)}>
      <div className="text-center w-56">
        ...
        <div className="mx-auto my-4 w-48">
          <h3 className="text-lg font-black text-gray-800">Confirm Winners</h3>
          <p className="text-sm text-text-500">
            Are you sure you want to upload winners for{" "}
            <span className="font-bold text-text-700">{event?.name}</span> event?
          </p>
